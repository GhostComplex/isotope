"""isotopes TUI — interactive terminal user interface.

This module provides the modular TUI implementation for isotopes,
restructured from isotopes-core/tui/main.py into clean, modular components.
...
Usage:
    from isotopes.tui import TUI, main
