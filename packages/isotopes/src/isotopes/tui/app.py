"""Main TUI application for isotopes.

This module provides the interactive terminal user interface for isotopes,
...
from isotopes.presets import CODING
...
class TUI:
    ...
    async def _run_setup_wizard(self) -> IsotopeConfig:
        ...
        from isotopes.config import ProviderConfig
    ...
    async def run(self) -> None:
        ...
        _print(f"isotopes TUI v{__version__}", style="info")
