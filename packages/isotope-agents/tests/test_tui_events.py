"""Tests for isotope_agents.tui.events module.
...
from isotope_agents.tui.events import EventAction, process_event
...
class TestMessageEnd:
    ...
    def test_assistant_message_no_text_blocks(self) -> None:
        ...
        from isotope_core.types import ToolCallContent
