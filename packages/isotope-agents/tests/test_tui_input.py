"""Tests for isotope_agents.tui.input module.
...
from isotope_agents.tui.input import StreamInputHandler
...
class TestHasPromptToolkit:
    ...
    def test_matches_module_constant(self) -> None:
        from isotope_agents.tui.input import HAS_PROMPT_TOOLKIT
