"""Tests for isotopes_core.context module — Milestone 3."""
...
from isotopes_core.context import (
    _CHARS_PER_TOKEN,
    _HAS_TIKTOKEN,
...
class TestTokenCountingFallback:
    ...
    def test_fallback_estimation(self) -> None:
        ...
        msg = _user(text)
        with patch("isotopes_core.context._get_encoding", return_value=None):
...
class TestTransformHookWithAgentLoop:
    ...
    async def test_sliding_window_hook_signature(self) -> None:
        ...
        from isotopes_core.loop import TransformContextHook
