"""Tests for isotopes_core.loop module."""
...
from isotopes_core.loop import (
...
class _ErrorStreamProvider:
    ...
    from isotopes_core.providers.base import StreamErrorEvent
...
class TestAgentLoopBudget:
    ...
    async def test_max_turns_with_on_agent_end_hook(self) -> None:
        ...
        from isotopes_core.middleware import LifecycleHooks
    ...
    async def test_max_budget_with_on_agent_end_hook(self) -> None:
        ...
        from isotopes_core.middleware import LifecycleHooks
        from isotopes_core.types import Usage
