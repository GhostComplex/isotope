"""Tests for isotopes_core.middleware — chain ordering, passthrough, suppression, modification."""
...
from isotopes_core.loop import AgentLoopConfig, agent_loop
from isotopes_core.middleware import (
    MiddlewareContext,
